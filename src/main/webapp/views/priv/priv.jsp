...
<body>
	<div class="main-container" id="main-container">
		...
		<div class="page-content">
			<form action="/priv/modPrivIds.do" method="post">
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="clearfix">
												<div class="grid3">
													<div class="row">
														<label> <input name="idenName" type="radio"
															class="ace" value="普通管理员"><span
																class="lbl">&nbsp;&nbsp;<span
																class="label label-xlg label-purple arrowed arrowed-left">普通管理员</span>
														</span> </label>
													</div>
												</div>
											</div>
											...
											<div class="clearfix">
												<div class="grid3">
													<div class="row">
														<label> <input name="idenName" type="radio"
															class="ace" value="超级管理员"><span
																class="lbl">&nbsp;&nbsp;<span
																class="label label-xlg label-primary arrowed arrowed-right">超级管理员</span>
														</span> </label>
													</div>
												</div>
											</div>
											...
											<div class="clearfix">
												<div class="grid3">
													<div class="row">
														<label> <input name="idenName" type="radio"
															class="ace" value="游客"><span class="lbl">&nbsp;&nbsp;<span
																class="label label-xlg label-pink arrowed arrowed-right">游客</span>
														</span> </label>
													</div>
												</div>
											</div>
										...
										<div class="widget-main">
											...
											<div class="clearfix">
												<div class="row">
													...
													<div class="col-sm-9">
														<label
															class="label label-xlg label-purple arrowed-in arrowed-in-right">活动管理</label>
													</div>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="clearfix">
												<div class="row">
													...
													<div class="col-sm-9">
														<label
															class="label label-xlg label-pink arrowed-in arrowed-in-right">活动一览</label>
													</div>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="clearfix">
												<div class="row">
													...
													<div class="col-sm-9">
														<label
															class="label label-xlg label-yellow arrowed-in arrowed-in-right">活动报名</label>
													</div>
												</div>
											</div>
											<div class="space-4"></div>
											<div class="clearfix">
												<div class="row">
													...
													<div class="col-sm-9">
														<label
															class="label label-xlg label-primary arrowed-in arrowed-in-right">用户交流</label>
													</div>
												</div>
											</div>
										</div>
...
<script type="text/javascript" src="${basePath}/boss/js/neusoft/jquery-2.0.3.min.js"></script>
<script type="text/javascript">
	$(function() {
		$('input[name=idenName]').click(function() {
			$.ajax({
				type : "GET",
