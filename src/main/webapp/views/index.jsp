...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            <iframe id="iframe" name="right" src="/customer/userList" width="100%"
                    height="700" scrolling="no" onload="iframeLoad()">
            </iframe>
        </div>
...
<!--[if lte IE 8]>
<script src="boss/js/neusoft/excanvas.min.js"></script>
<![endif]-->

<script src="${basePath}/boss/js/neusoft/jquery-ui-1.10.3.custom.min.js"></script>
<script src="${basePath}/boss/js/neusoft/jquery.ui.touch-punch.min.js"></script>
<script src="${basePath}/boss/js/neusoft/jquery.slimscroll.min.js"></script>
<script src="${basePath}/boss/js/neusoft/jquery.easy-pie-chart.min.js"></script>
<script src="${basePath}/boss/js/neusoft/jquery.sparkline.min.js"></script>
<script src="${basePath}/boss/js/neusoft/flot/jquery.flot.min.js"></script>
<script src="${basePath}/boss/js/neusoft/flot/jquery.flot.pie.min.js"></script>
<script src="${basePath}/boss/js/neusoft/flot/jquery.flot.resize.min.js"></script>
